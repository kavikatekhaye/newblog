  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{{route('admin.blog.edit',$d->id)}}"><button type="Edit" class="btn btn-success">edit</button> <a href="{{route('admin.blog.delete',$d->id)}}"><button type="delete" class="btn btn-danger">delete</button> </td>
